-- ============================================================================
-- Migration: Update create_order to use order_item_selections table
-- Depends on: 000029_rename_order_item_selected_options_to_selections
-- ============================================================================
...
BEGIN
    ...
    IF COALESCE(jsonb_array_length(p_items), 0) > 0 THEN
        ...
        LOOP
            ...
            -- Insert selected options for this item (using renamed table)
