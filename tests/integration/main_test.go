...
func InitializeScenario(sc *godog.ScenarioContext) {
	...
	getCategoryByIDSteps := steps.NewGetCategoryByIDSteps()
	...
	getShopByIDSteps := steps.NewGetShopByIDSteps()
	updateShopSteps := steps.NewUpdateShopSteps()
	checkSlugAvailabilitySteps := steps.NewCheckSlugAvailabilitySteps()
	...
	deleteProductSteps.RegisterSteps(sc)
	...
	getShopByIDSteps.RegisterSteps(sc)
	updateShopSteps.RegisterSteps(sc)
	checkSlugAvailabilitySteps.RegisterSteps(sc)
