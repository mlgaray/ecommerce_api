...
func (_mock *UserRepository) AssignRole(ctx context.Context, userID int, roleID int) error {
...
func (_c *UserRepository_AssignRole_Call) Return(err error) *UserRepository_AssignRole_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *UserRepository_AssignRole_Call) RunAndReturn(run func(ctx context.Context, userID int, roleID int) error) *UserRepository_AssignRole_Call {
	_c.Call.Return(run)
	return _c
}

// Create provides a mock function for the type UserRepository
func (_mock *UserRepository) Create(ctx context.Context, user *models.User) (*models.User, error) {
...
func (_c *UserRepository_Create_Call) Return(user1 *models.User, err error) *UserRepository_Create_Call {
	_c.Call.Return(user1, err)
	return _c
}

func (_c *UserRepository_Create_Call) RunAndReturn(run func(ctx context.Context, user *models.User) (*models.User, error)) *UserRepository_Create_Call {
	_c.Call.Return(run)
	return _c
}
